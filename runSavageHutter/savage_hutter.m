% File:	savage_hutter.m				Chris G. Johnson, Univ. of Manchester
%       ---------------
%
...
function savage_hutter
    ...
    function [td, maxa] = timederivs(uv)
		...
		% Return maximum absolute wave speed for variable timestep length
		% calculation
    ...
    % Wavespeeds, using max(h,0) to avoid any issues with square root of
    % negative h. Implements Eqs. (2.22) and (2.23)
